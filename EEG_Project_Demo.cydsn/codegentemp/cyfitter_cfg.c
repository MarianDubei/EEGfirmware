...
void cyfitter_cfg(void)
{
...

	{
		...
		static const uint8 CYCODE BS_UDB_0_1_1_CONFIG_VAL[] = {
			0x60u, 0x9Au, 0x00u, 0x00u, 0x01u, 0x98u, 0x00u, 0x02u, 0x07u, 0x21u, 0x38u, 0xD8u, 0x84u, 0x02u, 0x00u, 0x00u, 
			0x04u, 0x9Au, 0x00u, 0x00u, 0x56u, 0x13u, 0x09u, 0x64u, 0x0Au, 0xFCu, 0x10u, 0x03u, 0x84u, 0x38u, 0x00u, 0xC0u, 
			0x04u, 0x00u, 0x80u, 0x00u, 0x80u, 0x00u, 0x04u, 0x00u, 0x84u, 0x02u, 0x00u, 0x98u, 0x00u, 0x98u, 0x00u, 0x02u, 
			0x80u, 0x00u, 0x02u, 0x13u, 0x7Fu, 0x0Fu, 0x08u, 0xE0u, 0x20u, 0x00u, 0x00u, 0xA0u, 0x00u, 0x00u, 0x45u, 0x00u, 
			0x23u, 0x06u, 0x40u, 0x00u, 0x05u, 0xBEu, 0xDCu, 0x0Fu, 0x1Fu, 0xFFu, 0xFFu, 0xFFu, 0x22u, 0x00u, 0xF0u, 0x08u, 
			0x04u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x02u, 0x24u, 0x04u, 0x04u, 0x04u, 0x04u, 0x11u, 0x11u, 0x00u, 0x01u, 
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00003003u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x08000000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x00420000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x15000000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DB0006u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000009u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00000C46u);
