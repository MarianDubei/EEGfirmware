// ======================================================================
// EEG_Project_Demo.v generated from TopDesign.cysch
// 01/21/2020 at 02:31
...
module BLE_v3_50_0 (
	...
	cy_clock_v1_0
		#(.id("723497d9-88c9-4a89-8b2d-7a0748389a9c/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module CapSense_CSD_P4_v2_60_5 ;
	...
	cy_clock_v1_0
		#(.id("b3b17d10-dcb0-4bb8-a904-7403c0fa0078/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("b3b17d10-dcb0-4bb8-a904-7403c0fa0078/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b3b17d10-dcb0-4bb8-a904-7403c0fa0078/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("b3b17d10-dcb0-4bb8-a904-7403c0fa0078/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("fb3a8305-ba72-4cc3-99ce-91c176dc77b9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("749e1207-0a37-423d-8801-497886505433"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Pin_SS_net;
	wire [0:0] tmpFB_0__Pin_SS_net;
	wire [0:0] tmpIO_0__Pin_SS_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SS_net;
	electrical [0:0] tmpSIOVREF__Pin_SS_net;

	cy_psoc3_pins_v1_10
		#(.id("10cf6922-9575-42de-abc5-e06f9c0ff968"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SS
		 (.oe(tmpOE__Pin_SS_net),
		  .y({Net_110}),
		  .fb({tmpFB_0__Pin_SS_net[0:0]}),
		  .io({tmpIO_0__Pin_SS_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SS_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4c6d0881-9399-4126-9fd9-ed6ca1082e22"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b8091e70-a458-497f-91fa-832666208347"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("bb4f3d62-381d-4f59-a574-2f0f22b726c0"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__PIN_ADS1299_RESET_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_RESET_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_RESET_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_RESET_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_RESET_net;

	cy_psoc3_pins_v1_10
		#(.id("f19336c2-ad75-4459-a1ab-53946b9ea73c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_RESET
		 (.oe(tmpOE__PIN_ADS1299_RESET_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_RESET_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_RESET_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_RESET_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_RESET_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_RESET_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_ADS1299_START_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_START_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_START_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_START_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_START_net;

	cy_psoc3_pins_v1_10
		#(.id("48775f9f-cc16-401d-9eda-40e438876a7e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_START
		 (.oe(tmpOE__PIN_ADS1299_START_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_START_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_START_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_START_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_START_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_START_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_ADS1299_PWDN_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_PWDN_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_PWDN_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_PWDN_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_PWDN_net;

	cy_psoc3_pins_v1_10
		#(.id("d086fb75-4c76-4fff-9182-823b9a6de322"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_PWDN
		 (.oe(tmpOE__PIN_ADS1299_PWDN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_PWDN_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_PWDN_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_PWDN_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_PWDN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_PWDN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_ADS1299_DRDY_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_DRDY_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_DRDY_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_DRDY_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_DRDY_net;

	cy_psoc3_pins_v1_10
		#(.id("f9b0eb01-657a-4dc5-a886-3720a58e4611"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_DRDY
		 (.oe(tmpOE__PIN_ADS1299_DRDY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_DRDY_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_DRDY_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_DRDY_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_DRDY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_DRDY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_ADS1299_GPIO_1_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_GPIO_1_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_GPIO_1_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_GPIO_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_GPIO_1
		 (.oe(tmpOE__PIN_ADS1299_GPIO_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_GPIO_1_net[0:0]}),
		  .io({Net_203}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_GPIO_1_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_GPIO_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_GPIO_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_ADS1299_GPIO_2_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_GPIO_2_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_GPIO_2_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_GPIO_2_net;

	cy_psoc3_pins_v1_10
		#(.id("5b15b75a-d5e4-4f2d-81ee-d275fe249883"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_GPIO_2
		 (.oe(tmpOE__PIN_ADS1299_GPIO_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_GPIO_2_net[0:0]}),
		  .io({Net_204}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_GPIO_2_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_GPIO_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_GPIO_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_ADS1299_GPIO_3_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_GPIO_3_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_GPIO_3_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_GPIO_3_net;

	cy_psoc3_pins_v1_10
		#(.id("85080deb-6da2-4f7e-9a13-38b0bfc1a364"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_GPIO_3
		 (.oe(tmpOE__PIN_ADS1299_GPIO_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_GPIO_3_net[0:0]}),
		  .io({Net_205}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_GPIO_3_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_GPIO_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_GPIO_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_ADS1299_GPIO_4_net;
	wire [0:0] tmpFB_0__PIN_ADS1299_GPIO_4_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ADS1299_GPIO_4_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_GPIO_4_net;

	cy_psoc3_pins_v1_10
		#(.id("1b2e0420-df52-4df2-aa09-95c3c3d43296"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ADS1299_GPIO_4
		 (.oe(tmpOE__PIN_ADS1299_GPIO_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_GPIO_4_net[0:0]}),
		  .io({Net_206}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_GPIO_4_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ADS1299_GPIO_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ADS1299_GPIO_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CapSense_CSD_P4_v2_60_5 capsense ();
