...
*
* \brief
* Provides the source code to the API for the CLK_1 Component.
*
********************************************************************************
* \copyright
...
#if !defined(CY_CLK_1_NAME_CLK_1_H)
#define CY_CLK_1_NAME_CLK_1_H
...
#define CLK_1_DIV_NUM ((uint32_t)CLK_1__DIV_NUM)
/** The peripheral clock divider type */
#define CLK_1_DIV_TYPE ((cy_en_divider_types_t)CLK_1__DIV_TYPE)
/** @} group_macros */
...
*
*******************************************************************************/
__STATIC_INLINE void CLK_1_Enable(void)
{
    (void)Cy_SysClk_PeriphEnableDivider(CLK_1_DIV_TYPE, CLK_1_DIV_NUM);
}

/*******************************************************************************
* Function Name: CLK_1_Disable
****************************************************************************//**
*
...
*
*******************************************************************************/
__STATIC_INLINE void CLK_1_Disable(void)
{
    (void)Cy_SysClk_PeriphDisableDivider(CLK_1_DIV_TYPE, CLK_1_DIV_NUM);
}

/*******************************************************************************
* Function Name: CLK_1_SetDivider
****************************************************************************//**
*
* Sets the value of a programmable clock divider assigned to this Component.
* This is only used for integer dividers. Use CLK_1_SetFracDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void CLK_1_SetDivider(uint32_t dividerValue)
{
    (void)Cy_SysClk_PeriphSetDivider(CLK_1_DIV_TYPE, CLK_1_DIV_NUM, dividerValue);
}

/*******************************************************************************
* Function Name: CLK_1_GetDivider
****************************************************************************//**
*
...
* Use CLK_1_GetFracDivider() with a fractional divider.
*
* \param None
*
* \return
...
*
*******************************************************************************/
__STATIC_INLINE uint32_t CLK_1_GetDivider(void)
{
    return Cy_SysClk_PeriphGetDivider(CLK_1_DIV_TYPE, CLK_1_DIV_NUM);
}

/*******************************************************************************
* Function Name: CLK_1_SetFracDivider
****************************************************************************//**
*
* Sets the values of a programmable clock divider assigned to this Component.
* This is only used for fractional dividers. Use CLK_1_SetDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void CLK_1_SetFracDivider(uint32_t dividerIntValue, uint32_t dividerFracValue)
{
    (void)Cy_SysClk_PeriphSetFracDivider(CLK_1_DIV_TYPE, CLK_1_DIV_NUM, dividerIntValue, dividerFracValue);
}

/*******************************************************************************
* Function Name: CLK_1_GetFracDivider
****************************************************************************//**
*
...
* Use CLK_1_GetDivider() with an integer divider.
*
* \param *dividerIntValue
...
*
*******************************************************************************/
__STATIC_INLINE void CLK_1_GetFracDivider(uint32_t *dividerIntValue, uint32_t *dividerFracValue)
{
    Cy_SysClk_PeriphGetFracDivider(CLK_1_DIV_TYPE, CLK_1_DIV_NUM, dividerIntValue, dividerFracValue);
}

/** @} general */

#endif /* CY_CLOCK_CLK_1_H */
