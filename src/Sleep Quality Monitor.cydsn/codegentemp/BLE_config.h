 ...
 */
#define CY_BLE_BRAINWAVES_SERVICE_INDEX   (0x00u) /* Index of brainwaves service in the cy_ble_customs array */
#define CY_BLE_BRAINWAVES_BRAINWAVESCHAR_CHAR_INDEX   (0x00u) /* Index of brainwaveschar characteristic */
#define CY_BLE_BRAINWAVES_BRAINWAVESCHAR_BRAINWAVESCCCD_DESC_INDEX   (0x00u) /* Index of brainwavescccd descriptor */
#define CY_BLE_BRAINWAVES_BRAINWAVESCHAR_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_BRAINWAVES_SERVICE_HANDLE   (0x0010u) /* Handle of brainwaves service */
#define CY_BLE_BRAINWAVES_BRAINWAVESCHAR_DECL_HANDLE   (0x0011u) /* Handle of brainwaveschar characteristic declaration */
#define CY_BLE_BRAINWAVES_BRAINWAVESCHAR_CHAR_HANDLE   (0x0012u) /* Handle of brainwaveschar characteristic */
#define CY_BLE_BRAINWAVES_BRAINWAVESCHAR_BRAINWAVESCCCD_DESC_HANDLE   (0x0013u) /* Handle of brainwavescccd descriptor */
#define CY_BLE_BRAINWAVES_BRAINWAVESCHAR_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */
