// ======================================================================
// Sleep Quality Monitor.v generated from TopDesign.cysch
// 09/01/2020 at 23:10
...
module top ;
	...
	wire [0:0] tmpFB_0__PIN_ADS1299_SCLK_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_SCLK_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_SCLK_net;
	...
	cy_mxs40_gpio_v1_0
		...
		PIN_ADS1299_SCLK
		 (.oe({1'b1}),
		  .y({Net_13}),
		  .fb({tmpFB_0__PIN_ADS1299_SCLK_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_SCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_SCLK_net));


	wire [0:0] tmpFB_0__PIN_ADS1299_DIN_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_DIN_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_DIN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		PIN_ADS1299_DIN
		 (.oe({1'b1}),
		  .y({Net_12}),
		  .fb({tmpFB_0__PIN_ADS1299_DIN_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_DIN_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_DIN_net));


	wire [0:0] tmpIO_0__PIN_ADS1299_DOUT_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_DOUT_net;
	...
	cy_mxs40_gpio_v1_0
		...
		PIN_ADS1299_DOUT
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({Net_11}),
		  .io({tmpIO_0__PIN_ADS1299_DOUT_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_DOUT_net));


	wire [0:0] tmpFB_0__PIN_ADS1299_CS_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_CS_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_CS_net;
	...
	cy_mxs40_gpio_v1_0
		...
		PIN_ADS1299_CS
		 (.oe({1'b1}),
		  .y({Net_14}),
		  .fb({tmpFB_0__PIN_ADS1299_CS_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_CS_net));
	...
	wire [3:0] tmpFB_3__PIN_ADS1299_GPIO_net;
	wire [3:0] tmpIO_3__PIN_ADS1299_GPIO_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_GPIO_net;
	...
	cy_mxs40_gpio_v1_0
		...
		PIN_ADS1299_GPIO
		 (.oe({4'b1111}),
		  .y({4'b0}),
		  .fb({tmpFB_3__PIN_ADS1299_GPIO_net[3:0]}),
		  .io({tmpIO_3__PIN_ADS1299_GPIO_net[3:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_GPIO_net));
	...
	wire [0:0] tmpFB_0__PIN_ADS1299_CLK_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_CLK_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_CLK_net;
	...
	cy_mxs40_gpio_v1_0
		...
		PIN_ADS1299_CLK
		 (.oe({1'b1}),
		  .y({Net_142}),
		  .fb({tmpFB_0__PIN_ADS1299_CLK_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_CLK_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_CLK_net));


	wire [0:0] tmpFB_0__PIN_ADS1299_CLKSEL_net;
	wire [0:0] tmpIO_0__PIN_ADS1299_CLKSEL_net;
	electrical [0:0] tmpSIOVREF__PIN_ADS1299_CLKSEL_net;
	...
	cy_mxs40_gpio_v1_0
		...
		PIN_ADS1299_CLKSEL
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ADS1299_CLKSEL_net[0:0]}),
		  .io({tmpIO_0__PIN_ADS1299_CLKSEL_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ADS1299_CLKSEL_net));
