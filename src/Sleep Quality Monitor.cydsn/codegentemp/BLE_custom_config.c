...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* brainwaves service */
    {
        0x0010u, /* Handle of the brainwaves service */ 
        {

            /* brainwaveschar characteristic */
            {
                0x0012u, /* Handle of the brainwaveschar characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0013u, /* Handle of the brainwavescccd descriptor */ 
